...
module.exports = function ({ CAM, C, parseDxf, entityToPolys, dir, fs, path }) {
  ...
  const t10 = CAM.drillOp(slots, {
    toolNum: 10, toolDia: 0.125, topZ: 0, cutDepth: 0.5, peck: 0,
    feed: 62.5, plunge: 20, rpm: 10000, order: 'optimize', orderStart: { x: 0, y: 0 },
  });
  const t5 = CAM.profileOp(shallow, {
    toolNum: 5, toolDia: 0.38, topZ: 0, cutDepth: 0.1, passDepth: 0.1,
    feed: 100, plunge: 25, rpm: 20000,
    openSide: 'right', entry: 'serpentine', order: 'sweep',
    orderStart: { x: 3.5, y: 48.5 },
    tabs: { count: 0, length: 0, height: 0 }, leadType: 'none', rampLen: 0,
  });
  const t8 = CAM.drillOp(holes, {
    toolNum: 8, toolDia: 0.375, topZ: 0, cutDepth: 1.5, peck: 0,
    feed: 62.5, plunge: 20, rpm: 10000, order: 'optimize', orderStart: { x: 0, y: 0 },
  });
  const pocket = CAM.pocketOp(circle, {
    toolNum: 3, toolDia: 0.375, topZ: 0, cutDepth: 0.5, passDepth: 0.25,
    stepover: 0.25, linkRings: true, climb: true, feed: 60, plunge: 20, rpm: 18000,
  });
  const finish = CAM.profileOp(circle, {
  ...
  const cross = CAM.profileOp(open, {
