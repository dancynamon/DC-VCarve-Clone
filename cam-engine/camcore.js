...
function profileOp(contours, opts){
  const o=Object.assign({toolNum:1,toolDia:0.25,side:'outside',climb:true,topZ:0,cutDepth:0.25,passDepth:0.125,safeZ:0.25,feed:120,plunge:40,rpm:18000,tabs:{count:0,length:0.4,height:0.06},joinType:'round',leadType:'none',leadLen:0.25,rampLen:0,leadAngle:0,overcut:0,order:'source',entry:'source'},opts||{});
  ...
  let prevEntry = o.orderStart || {x:0,y:0};   // entry:'nearest' chains each entry to the last one
  for(const c of seq){
    let loops;
